...
interface HttpReqProps {
    ...
    defaultValues?: Partial<HttpReqFormValues>
}

export const HttpReqDialog = ({ open, onOpenChange, onSubmit, defaultValues = {} }: HttpReqProps) => {
    ...
    const watchVarName = form.watch("variableName") || "myApiCall"
